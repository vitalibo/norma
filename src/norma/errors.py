...
TIME_TYPE = Details('time_type', 'Input should be a valid time')
TIME_PARSING = Details('time_parsing', 'Input should be in a valid time format, unable to parse string as a time')
...
DURATION_TYPE = Details('duration_type', 'Input should be a valid duration')
DURATION_PARSING = Details('duration_parsing', 'Input should be a valid duration, unable to parse string as a duration')
...
UNIQUE_ITEMS = Details('unique_items', 'Input should not contain duplicate items')
